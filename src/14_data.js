...
const TPL = {
  ...
  kettle:{name:'Kettle',role:'Sapper · Moranth munitions',sig:'K',col:'#e07a45',hp:16,ac:13,atk:3,dmg:[1,8,0],rng:5,mv:4,init:2,st:{might:1,wits:2,guile:2},ab:['sharper','burner','cusser','salve'],
    ...
    rel:{brisk:'Calls her "the wall." Not to her face. Brisk knows.',tuft:'Shares a tent with her. Has stopped asking about the nightmares.',ohl:'He stitched her hand at Nathilog. She owes him and pays in tobacco.',ellis:'Trades her fuse-cord for arrows and has never once asked what the cord is for. For Kettle, not asking is a kind of vow.'}},
  ...
  ohl:{name:'Ohl',role:'Healer · Denul',sig:'O',col:'#7fb394',hp:16,ac:13,atk:2,dmg:[1,6,0],rng:1,mv:4,init:0,st:{might:1,wits:3,guile:0},ab:['mend','salve'],magic:true,
    ...
    rel:{brisk:'Calls her "child." She allows it.',kettle:'Nine stitchings. He is fond of her the way one is fond of weather.',tuft:'Worries. Says nothing. Watches the lamp.',ellis:'Toc asked him to look at her hand. He is waiting to be let, and he is better at waiting than she is at refusing.'}},
  ellis:{name:'Ellis',role:'Scout · Claw-trained',sig:'E',col:'#8fb3a0',hp:13,ac:13,atk:4,dmg:[1,6,1],rng:5,mv:6,init:3,st:{might:0,wits:2,guile:3},ab:['mark','salve'],
    ...
    rel:{brisk:'Brisk watched her walk for a day and then stopped watching. That is a promotion.',kettle:'They trade: arrows for fuse-cord, and neither has said what for.',tuft:'Ellis watches her the way she watched sentries. Tuft has noticed and, oddly, does not mind.',ohl:'He asked about the glove. She said "later." He wrote nothing down, and she noticed.'}},
};
...
const PICKS = {
  3:{ sgt:[['discipline','Marine Discipline','Every squadmate wears +1 armour. Eleven years of telling people where to stand.'],['sappers_eye','Sapper\'s Eye','The squad rolls +2 initiative, and the sergeant\'s free swings hit +2.']],
      ...
      kettle:[['longfuse','Long Fuse','Munitions never scatter, and throw one tile further.'],['quorl','Quorl Signal','Once a fight: a Moranth drop. A sharper from the sky, anywhere within 5, not from the satchel.']],
