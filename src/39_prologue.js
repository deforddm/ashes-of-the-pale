...
`She studies you over the cards, long enough to decide something.
...
Behind you, Tuft has gone very still.`, ch:tatRest(), fx:()=>{S.f.knowStakes=1;}}),
  tat_wits_fail:()=>({sp:'Tattersail', scene:'tent', txt:`"Paper, Sergeant. It's full of paper." The cards offer you nothing more, and neither does she.`, ch:tatRest()}),
...
`Water has got in under the oilcloth. The ink has run, pages of it, too wet to read, except for one name that keeps surfacing like a drowned man: *Tayschrenn.*`,
  ...
  journal_closed:()=>({sp:'Collapsed junction', txt:`You buckle the satchel shut. Brisk grunts her approval. Tuft looks at the satchel the whole way up.`,
    ch:[{t:'Head for the surface.', go:()=>talk(S.f.clawFooled ? 'final' : 'claw2')}]}),
  claw2:()=>({sp:'A grey cloak', scene:'explore', fx:()=>{S.f.clawMet=1;}, txt: S.f.clawMet ?
...
"Grave detail," he says pleasantly, before you can. "Find anything heavy? I'd be glad to carry it."`,
...
`He opens it on the spot. "Munitions counts," he says. "Charming." He hands it back to Kettle. His eyes don't smile. "The real one, Sergeant."`,
  ...
  final:()=> S.f.gaveClaw ? {sp:'Tattersail', scene:'tent', txt:
